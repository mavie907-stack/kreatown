...
A creator membership platform built with Next.js, Supabase, and Stripe.
...
### 1. Clone & Install
```bash
git clone https://github.com/yourusername/kreatown.git
cd kreatown
npm install
```
...
- [x] ✅ **Landing page** (kreatown.html)
- [x] ✅ **Project structure** (this!)
